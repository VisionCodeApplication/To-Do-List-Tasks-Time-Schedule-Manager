...
/*class CircularProgressBar: UIView {
    ...
    public var safePercent: Int = 100 {
        didSet{
            ...
            setBackgroundLayerColorForSafePercent()
        }
    }
    ...
    public func setProgress(to progressConstant: Double, withAnimation: Bool) {
        ...
        DispatchQueue.main.async {
            ...
            self.setBackgroundLayerColorForSafePercent()
            self.configLabel()
    ...
    public var forgroundColor: UIColor = UIColor(red: 36.0/255.0, green: 22.0/255.0, blue: 84.0/255.0, alpha: 1.0) {
        didSet{
            setForegroundLayerColorForSafePercent()
        }
    }

    public var trackColor: UIColor = UIColor(red: 155.0/255.0, green: 134.0/255.0, blue: 223.0/255.0, alpha: 0.6) {
        didSet{
            setBackgroundLayerColorForSafePercent()
        }
    }
    ...
    public var showLabel: Bool = false {
        didSet{
            self.label.isHidden = !showLabel
            self.labelPercent.isHidden = !showLabel
            self.labelComplete.isHidden = !showLabel
        }
    }
    ...
    private func drawBackgroundLayer(){
        ...
        self.backgroundLayer.strokeColor = UIColor(red: 155.0/255.0, green: 134.0/255.0, blue: 223.0/255.0, alpha: 0.0).cgColor
    ...
    private func drawForegroundLayer(){
        ...
        foregroundLayer.strokeColor = forgroundColor.cgColor
    ...
    private func setForegroundLayerColorForSafePercent(){
        ...
        self.foregroundLayer.strokeColor = forgroundColor.cgColor
    }
