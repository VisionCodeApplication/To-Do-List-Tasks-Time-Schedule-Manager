...
extension IAPHelper: SKPaymentTransactionObserver {
    ...
    private func restore(transaction: SKPaymentTransaction) {
        ...
        notificationCenter.post(name: NSNotification.Name(rawValue: "reloadSettingList"), object: nil, userInfo: nil)

        let alert = UIAlertController(title: "", message: "Restore Successfully.", preferredStyle: .alert)
